 ...
 */
class getEtudesSuperieuresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EtudesSuperieuresRepository' shared autowired service.
     *
     * @return \App\Repository\EtudesSuperieuresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EtudesSuperieuresRepository.php';

        return $container->privates['App\\Repository\\EtudesSuperieuresRepository'] = new \App\Repository\EtudesSuperieuresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
