 ...
 */
class getAcadimieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcadimieRepository' shared autowired service.
     *
     * @return \App\Repository\AcadimieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcadimieRepository.php';

        return $container->privates['App\\Repository\\AcadimieRepository'] = new \App\Repository\AcadimieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
