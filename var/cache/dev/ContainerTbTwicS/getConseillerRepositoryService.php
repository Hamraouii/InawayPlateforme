 ...
 */
class getConseillerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConseillerRepository' shared autowired service.
     *
     * @return \App\Repository\ConseillerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConseillerRepository.php';

        return $container->privates['App\\Repository\\ConseillerRepository'] = new \App\Repository\ConseillerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
