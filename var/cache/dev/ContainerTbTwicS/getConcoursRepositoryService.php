 ...
 */
class getConcoursRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConcoursRepository' shared autowired service.
     *
     * @return \App\Repository\ConcoursRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConcoursRepository.php';

        return $container->privates['App\\Repository\\ConcoursRepository'] = new \App\Repository\ConcoursRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
