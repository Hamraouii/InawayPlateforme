 ...
 */
class Secteur extends \App\Entity\Secteur implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'idSecteur' => [parent::class, 'idSecteur', null],
        "\0".parent::class."\0".'nom' => [parent::class, 'nom', null],
        'idSecteur' => [parent::class, 'idSecteur', null],
    ...
    public function __construct(?\Closure $initializer = null)
    {
        self::createLazyGhost($initializer, [
            "\0".parent::class."\0".'idSecteur' => true,
            '__isCloning' => true,
        ], $this);
    }
