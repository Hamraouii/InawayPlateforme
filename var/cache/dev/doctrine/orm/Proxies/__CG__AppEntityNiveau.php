 ...
 */
class Niveau extends \App\Entity\Niveau implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'idNiveau' => [parent::class, 'idNiveau', null],
        "\0".parent::class."\0".'nom' => [parent::class, 'nom', null],
        'idNiveau' => [parent::class, 'idNiveau', null],
    ...
    public function __construct(?\Closure $initializer = null)
    {
        self::createLazyGhost($initializer, [
            "\0".parent::class."\0".'idNiveau' => true,
            '__isCloning' => true,
        ], $this);
    }
