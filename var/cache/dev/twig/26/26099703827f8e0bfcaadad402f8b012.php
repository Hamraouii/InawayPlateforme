    ...
    <div class=\"mdk-header-layout__content page-content \">
        ...
        echo "\" width=\"104\"
                ...
                <div class=\"flex mb-32pt mb-md-0\">
                    <h2 class=\"text-white mb-0\">Ahmed Ouriarhi</h2>
                ...
                <div class=\"col-xl-3 col-lg-6\">
                    <div class=\"card card-stats mb-4 mb-xl-0\">
                        <div class=\"card-body\">
                            <div class=\"row\">
                                <div class=\"col\">
                                    <h5 class=\"card-title text-uppercase text-muted mb-0\" style=\"text-align:center;\">
                                        Articles</h5>
                                    <div class=\"text-center\" style=\"margin-top:20px;\">
                                        <button class=\"btn-primary\"
                                            onclick=\"document.getElementById('wifi').style.display='block'\"
                                            style=\"border-radius:10px;cursor:pointer;\">Ajouter</button>
                                    </div>
                                    <!--Ajouter-->
                                            ...
                                            <div class='modal-footer' style=\"background-color:#f1f1f1;\">
                                                <div class=\"col-2 text-right\">
                                                    <button type=\"submit\" class=\"btn btn-sm btn-primary\" name=\"Add\"
                                                        style=\"color:white;\">Ajouter</button>
                                                </div>
                                                <div class=\"col-2 text-right\">
                                                    <button type=\"button\"
                                                        onclick=\"document.getElementById('wifi').style.display='none'\"
                                                        class=\"btn btn-sm btn-danger\"
                                                        style=\"color:white;\">Fermer</button>
                                                </div>
                                            </div>
                                           </form>
                                        </div>
                                ...
                                <div class=\"col\">
                                    ...
                                    <div class=\"text-center\" style=\"margin-top:20px;\">
                                        <button class=\"btn-primary\" style=\"border-radius:10px;cursor:pointer;\"
                                            onclick=\"document.getElementById('even').style.display='block'\">Ajouter</button>
                                    </div>
                                    <!--Ajouter-->
                        ...
                        <div class=\"card-body\">
                            <div class=\"row\">
                                <div class=\"col\">
                                    ...
                                    <div class=\"text-center\" style=\"margin-top:20px;\">
                                        <button class=\"btn-primary\" style=\"border-radius:10px;cursor:pointer;\"
                                            onclick=\"document.getElementById('etude').style.display='block'\">Ajouter</button>
                                    </div>
                                    <!--Ajouter-->
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 382, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["n"]) {
            // line 383
            echo "                                                                    <option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["n"], "idSecteur", [], "any", false, false, false, 383), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["n"], "Nom", [], "any", false, false, false, 383), "html", null, true);
            echo "</option>
                                                                    ";
        }
                        ...
                        <div class=\"card-body\">
                            <div class=\"row\">
                                <div class=\"col\">
                                    ...
                                    <div class=\"text-center\" style=\"margin-top:20px;\">
                                        <button class=\"btn-primary\" style=\"border-radius:10px;cursor:pointer;\"
                                            onclick=\"document.getElementById('con').style.display='block'\">Ajouter</button>
                                    </div>
                                    <!--Ajouter-->
...
";
    ...
    {
        return array (  652 => 75,  634 => 59,  624 => 58,  533 => 427,  489 => 385,  478 => 383,  474 => 382,  402 => 313,  305 => 219,  235 => 152,  171 => 91,  165 => 87,  163 => 58,  159 => 56,  149 => 55,  90 => 5,  80 => 4,  61 => 3,  38 => 1,);
    }
                            ...
                            <div class=\"row\">
                                <div class=\"col\">
                                    ...
                                    <div class=\"modal1\" id=\"wifi\">
                                        <div class=\"modal-content1 animate\">
                                            <div class=\"container1\" style=\"padding:70px;\">
                                                <form action=\"{{path('publier',{type:'article'})}}\" method=\"post\" enctype=\"multipart/form-data\">
                                                    <div class=\"row\">
                                                        <div class=\"col-lg-12\">
                                                            <div class=\"form-group\">
                                                                <label>Titre</label>
                            ...
                            <div class=\"row\">
                                <div class=\"col\">
                                    ...
                                    <div class=\"modal1\" id=\"even\">
                                        <div class=\"modal-content1 animate\">
                                            <div class=\"container1\" style=\"padding:70px;\">
                                                <form action=\"{{path('publier',{type:'evenement'})}}\" method=\"post\" enctype=\"multipart/form-data\">
                                                    <div class=\"row\">
                                                        <div class=\"col-lg-6\">
                                                            <div class=\"form-group\">
                                                                <label>Nom</label>
                            ...
                            <div class=\"row\">
                                <div class=\"col\">
                                    ...
                                    <div class=\"modal1\" id=\"etude\">
                                        <div class=\"modal-content1 animate\">
                                            <div class=\"container1\" style=\"padding:70px;\">
                                                <form action=\"{{path('publier',{type:'etudes_superieures'})}}\" method=\"post\" enctype=\"multipart/form-data\">
                                                    <div class=\"row\">
                                                        <div class=\"col-lg-6\">
                                                            <div class=\"form-group\">
                                                                <label>Nom d'université</label>
                            ...
                            <div class=\"row\">
                                <div class=\"col\">
                                    ...
                                    <div class=\"modal1\" id=\"con\">
                                        <div class=\"modal-content1 animate\">
                                            <div class=\"container1\" style=\"padding:70px;\">
                                                <form action=\"{{path('publier',{type:'concours'})}}\" method=\"post\" enctype=\"multipart/form-data\">
                                                    <div class=\"row\">
                                                        <div class=\"col-lg-6\">
                                                            <div class=\"form-group\">
                                                                <label>Titre</label>
